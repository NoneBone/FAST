...
# # BITCOIN and WIKITALK
# wget -P ./DATA/BITCOIN https://nrvis.com/download/data/dynamic/soc-bitcoin.zip
# unzip ./soc-bitcoin.zip

# wget -P ./DATA/WIKITALK https://snap.stanford.edu/data/wiki-talk-temporal.txt.gz
